 ...
 */
package com.arelance.institutomunicipaldeportes.controler.registro;
...
public class PostRegistroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Login login = new Login(null, email, password);
        servicesLogin.altaLogin(login);

        request.getRequestDispatcher("PreRegistro2Servlet").forward(request, response);
    }
