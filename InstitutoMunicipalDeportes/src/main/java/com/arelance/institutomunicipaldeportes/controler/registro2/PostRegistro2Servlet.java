 ...
 * @author Gabri
 */
@WebServlet(name = "PostRegistro2Servlet", urlPatterns = {"/PostRegistro2Servlet"})
public class PostRegistro2Servlet extends HttpServlet {
