...
public class PreInscripcionesServlet extends HttpServlet {
    ...
    @Inject
    ServicesInscripcion servicesInscripcion;

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        List<Inscripcion> inscripcionesUsuario = servicesInscripcion.finByUser((Login) request.getSession().getAttribute("usuarioSesion"));
        request.setAttribute("inscripcionesUsuario", inscripcionesUsuario);
