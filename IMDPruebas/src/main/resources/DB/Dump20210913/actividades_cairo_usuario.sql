...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `fk_login_usuario1` FOREIGN KEY (`id_usuario`) REFERENCES `login` (`id_usuario_login`)
...
INSERT INTO `usuario` VALUES (8,'Jorge','Hurtado','1'),(9,'Pedro','Perez','2'),(10,'Antonio','Prieto','3'),(11,'Ruben','Huelva','4');
