...
CREATE TABLE `login` (
  ...
  UNIQUE KEY `email_login_UNIQUE` (`email_login`)
...
INSERT INTO `login` VALUES (1,'1@1','1'),(2,'2@2','1'),(3,'3@3','1'),(4,'4@4','1'),(5,'5@5','1');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `login_AFTER_INSERT` AFTER INSERT ON `login` FOR EACH ROW BEGIN
	INSERT INTO usuario (id_usuario) VALUES (NEW.id_usuario_login);
END */;;
DELIMITER ;
