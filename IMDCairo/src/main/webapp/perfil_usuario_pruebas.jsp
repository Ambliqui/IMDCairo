        ...
        <div style="height: 100px;" >
            ...
            <div class="row gutters">
                        ...
                        <div class="card-body">
                            <div class="account-settings">
                                <div class="user-profile">
                                    <img src="resources/images/pagina/perfiles/avatar.png" class="user-avatar" width="100%" alt="avatar">
                                    <h5><a href="#">Mis Datos Personales</a></h5>
                                    <h5><a href="#">Mis Metodos de Pago</a></h5>
                                    <h5><a href="#">Mis Actividades</a></h5>
                                                ...
                                                <h2 class="accordion-header" id="flush-headingOne">
                                                    <button id="btnTarjeta" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                                        <div class="form-check">
                                                            ...
                                                            <label id="lbTarjeta" class="form-check-label" for="tarjeta">Datos personales</label>
                                                        </div>
                                                    </button>
                                                </h2>
                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                    Comienzo de las seccion datos personales
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="row gutters">
