 ...
 */
@Stateless
@com.deportessa.proyectodeportes.frontController.qualifiers.ModificarActividad
public class ModificarActividad implements FrontControlerLocal{
    ...
    public RequestDispatcher getDispatcher(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        return request.getRequestDispatcher("./PreDetallesServlet");
