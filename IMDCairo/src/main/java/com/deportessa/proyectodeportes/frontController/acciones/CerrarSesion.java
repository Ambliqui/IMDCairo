 ...
 */
@Stateless
@com.deportessa.proyectodeportes.frontController.qualifiers.CerrarSesion
public class CerrarSesion implements FrontControlerLocal {
    ...
    public RequestDispatcher getDispatcher(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        return request.getRequestDispatcher("./CerrarSesionServlet");
    }
