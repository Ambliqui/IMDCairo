...
public class ActividadDAOImpl implements ActividadDAO {
    ...
    public List<Actividad> findAll() {
        ...
        CriteriaQuery<Actividad> criteriaQuery = cb.createQuery(Actividad.class);
        Root<Actividad> fromActividad = criteriaQuery.from(Actividad.class);
        criteriaQuery.select(fromActividad);
        TypedQuery<Actividad> query = em.createQuery(criteriaQuery);
